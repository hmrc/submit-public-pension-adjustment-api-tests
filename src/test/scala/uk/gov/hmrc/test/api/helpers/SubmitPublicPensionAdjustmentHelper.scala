...
import uk.gov.hmrc.test.api.service.SubmitPublicPensionAdjustmentService
...
class SubmitPublicPensionAdjustmentHelper {
  ...
  def readResponse(responseBody: String): SubmitPublicPensionAdjustmentResponse =
    (Json.parse(responseBody)).as[SubmitPublicPensionAdjustmentResponse]
